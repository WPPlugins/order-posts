...
Description: This plugin allows you to order posts by context (i.e. if you don't want to order posts by date).
Author: James Angus
Version: 0.2
						...
						<?php
							...
							if (is_array($posts) && count($posts) > 0) {
								...
								foreach ($posts as $post) { ?>
									<li<?php if (($i % 2) == 0) { ?> class="alternate"<?php } ?> style="padding: .2em .5em"><?echo $post->menu_order;?>.
